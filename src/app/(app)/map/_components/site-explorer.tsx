...
export const SiteExplorer = ({ initialSites, initialZones, initialBounds }: SiteExplorerProps) => {
  ...
  return (
    <div className="relative flex h-[calc(100vh-8rem)] md:h-[calc(100vh-6rem)] w-full overflow-hidden rounded-xl border border-border/40 bg-card/30">
      ...
      <div className="relative flex-1 flex flex-col min-w-0">
        ...
        <div className="absolute top-3 left-3 right-3 z-20 flex items-center gap-2">
          ...
          <div className="flex items-center gap-2">
            {isPending && (
              <Badge variant="outline" className="bg-card/95 text-xs">
                Loading...
              </Badge>
            )}
            <Button
        ...
        {/* Quick filter chips */}
        <div className="absolute top-14 left-3 z-10 flex gap-1.5 overflow-x-auto max-w-[calc(100%-1.5rem)] pb-1">
        ...
        {/* Floating editors */}
        {activeEditor === "site" && (
          <div className="absolute top-24 left-3 right-3 z-30 max-w-md">
            <SiteEditor
        ...
        {activeEditor === "zone" && (
          <div className="absolute top-24 left-3 right-3 z-30 max-w-md">
            <ZoneEditor 
              className="border border-secondary/40 bg-card shadow-xl rounded-xl" 
              onClose={() => setActiveEditor(null)} 
            />
          </div>
        )}
